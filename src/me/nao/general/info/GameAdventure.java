...
public class GameAdventure extends GameInfo{
	...
	public GameAdventure(String name,int maxplayers,int minplayers, GameType mision, EstadoPartida estpart, StopMotivo motivo, BossBar boss,
			String time,GameObjetivesMG objetives,List<String> participantes,List<String> spectator, List<String> vivo, List<String> muerto, List<String> arrivo,List<String> knocked,boolean o1 ,boolean o2) {
