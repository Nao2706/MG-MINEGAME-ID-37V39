...
import org.bukkit.inventory.meta.ItemMeta;
        ...
        public enum Items{
            ...
            MASCARAANTIGAS(""+ChatColor.GREEN+ChatColor.BOLD+"MASCARA ANTIGAS", Material.CREEPER_HEAD,null, 1, ChatColor.GREEN+"Te vuelve inmune al Gas Toxico.", ChatColor.GREEN+"Debes colcocarlo en tu Cabeza.", ChatColor.GOLD+"Durabilidad:"+ ChatColor.GREEN+" 30"+ChatColor.RED+"/"+ChatColor.GREEN+"30", ChatColor.GREEN+"Precio: "+ChatColor.RED+"64 de Hierro"),
            MASCARAANTIGASP(""+ChatColor.GREEN+ChatColor.BOLD+"MASCARA ANTIGAS", Material.CREEPER_HEAD,null, 1, ChatColor.GREEN+"Te vuelve inmune al Gas Toxico.", ChatColor.GREEN+"Debes colcocarlo en tu Cabeza.", ChatColor.GOLD+"Durabilidad:"+ ChatColor.GREEN+" 30"+ChatColor.RED+"/"+ChatColor.GREEN+"30"),
