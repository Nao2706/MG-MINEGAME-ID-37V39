...
//import me.nao.generalinfo.mg.TeamMg;
...
public class GameTeams {
	...
	public GameTeams(Minegame plugin) {
		this.plugin = plugin;
	}
...
//			
//			List<Map.Entry<String, TeamMg>> list = new ArrayList<>(gn.getTeams().entrySet());
//			
//			int index = 0;
//			for(Map.Entry<String, TeamMg> e : list) {
...
//			
//			List<Map.Entry<String, TeamMg>> list = new ArrayList<>(this.teams.entrySet());
//			List<String> l = new ArrayList<>();
//			
//			for(Map.Entry<String, TeamMg> tm : list) {
...
//			TeamMg team = gn.getTeams().get(pl.getTeamName());
//			
